...
def run_multihead_self_attention(
    ...
    mha = model.MultiHeadSelfAttention(d_model, num_heads, use_rope=False)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    mha = model.MultiHeadSelfAttention(d_model, num_heads, use_rope=True, theta=theta, max_seq_len=max_seq_len)
    mha.load_state_dict({"Q": q_proj_weight, "K": k_proj_weight, "V": v_proj_weight, "O": o_proj_weight})
